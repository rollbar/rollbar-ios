...
- (HttpMethod)method {
    return [HttpMethodUtil HttpMethodFromString:[self getDataByKey:DFK_METHOD]];
}

- (void)setMethod:(HttpMethod)method {
    [self setData:[HttpMethodUtil HttpMethodToString:method] byKey:DFK_METHOD];
}
...
- (instancetype)initWithHttpMethod:(HttpMethod)httpMethod
    ...
    self = [super initWithDictionary:@{
        DFK_METHOD: [HttpMethodUtil HttpMethodToString:httpMethod],
