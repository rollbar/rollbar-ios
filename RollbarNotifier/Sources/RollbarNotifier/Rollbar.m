...
+ (void)debugWithData:(NSDictionary<NSString *, NSObject *> *)data {
...
+ (void)infoWithData:(NSDictionary<NSString *, NSObject *> *)data {
...
+ (void)warningWithData:(NSDictionary<NSString *, NSObject *> *)data {
...
+ (void)errorWithData:(NSDictionary<NSString *, NSObject *> *)data {
...
+ (void)criticalWithData:(NSDictionary<NSString *, NSObject *> *)data {
