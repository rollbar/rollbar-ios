...
2. Follow the [Installation](https://docs.rollbar.com/docs/ios#section-installation) instructions in our [iOS/macOS SDK docs](https://docs.rollbar.com/docs/ios) to install rollbar-ios
